...
public class CustomWeekViewAdapter extends ArrayAdapter<Searchresult> {
    Context context;
    ...
    public CustomWeekViewAdapter(Context context, int layoutResourceId, ArrayList<Searchresult> data) {
