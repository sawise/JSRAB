 ...
 */
public class JsonTiresize extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
        try {
            APIManager.tiresizes.clear();
            APIManager.tiresizes.addAll(APIManager.getTiresizefromJSON(result));
        } catch (Exception e) {}
    }
