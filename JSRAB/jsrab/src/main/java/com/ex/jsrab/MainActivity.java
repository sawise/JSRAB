...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    public static class DummySectionFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_colorpicker_dummy, container, false);
    ...
    protected void onSaveInstanceState(Bundle outState){
        getSupportFragmentManager().getFragment(outState, "test");
    }

    @Override
    protected void onRetoreInstanceState(Bundle inState){
        test = getSupportFragmentManager().getFragment(inState,"test");
    }*/
