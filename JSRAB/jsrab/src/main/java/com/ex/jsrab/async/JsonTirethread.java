 ...
 */
public class JsonTirethread extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
        try {
            APIManager.tirethreads.clear();
            APIManager.tirethreads.addAll(APIManager.getTirethreadfromJSON(result));
        } catch (Exception e) {}
    }
